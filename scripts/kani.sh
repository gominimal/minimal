...
# (PathDecision combination lattice, the egress frame verdict, the
# rebinding intersection, and the loopback address allocator) and bep
# (the redemption decision and the audit chain's walk).
#
