TOOLCHAIN_SYSROOT="/opt/toolchain/x86_64-unknown-linux-gnu/sysroot"
...
export LDFLAGS="--sysroot=$TOOLCHAIN_SYSROOT -Wl,--dynamic-linker=$DYNAMIC_LINKER -Wl,-rpath=$TOOLCHAIN_SYSROOT/lib64"
